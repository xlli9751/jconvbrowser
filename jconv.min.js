(function () {
    function t(c) { switch (c.toUpperCase()) { case "WINDOWS-31J": case "CP932": case "SJIS": case "SHIFTJIS": case "SHIFT_JIS": return "SJIS"; case "EUCJP": case "EUC-JP": return "EUCJP"; case "JIS": case "ISO2022JP": case "ISO-2022-JP": case "ISO-2022-JP-1": return "JIS"; case "UTF8": case "UTF-8": return "UTF8"; case "UNICODE": case "UCS2": case "UCS-2": case "UTF16LE": case "UTF-16LE": return "UCS2"; default: return "" } } function q(c, k, g) {
        ...
        k, g) { return n.convert(c, k, g) }; n.defineEncoding = function (c) { s[c.name] = new function (c) { this.name = c.name; this.convert = c.convert }(c) }; n.convert = function (c, k, g) { k = t(k); g = t(g); if (!k || !g) throw Error("Encoding not recognized."); c = c || new Buffer(0); c = c instanceof Buffer ? c : new Buffer(c.toString(), "UTF8"); if (k === g) return c; var h = s[k + "to" + g]; if (h) return h.convert(c); k = s[k + "toUCS2"]; g = s["UCS2to" + g]; if (k && g) return g.convert(k.convert(c)); throw Error("Encoding not recognized."); }; n.decode = function (c, k) {
            ...
            name: "EUCJPtoUTF8",
            convert: function (c) { for (var k = p.JIS, g = p.JISEXT, h = c.length, f = new Buffer(2 * h), b = 0, a, d = 0; d < h;) { a = c[d++]; if (!(128 > a)) if (142 === a) a = c[d++] + 65216; else if (143 === a) { a = c[d++] - 128; var e = c[d++] - 128; a = (a << 8) + e; a = g[a] || 12539 } else e = a - 128, a = c[d++] - 128, a = (e << 8) + a, a = k[a] || 12539; b = q(a, f, b) } return f.slice(0, b) }
        }); n.defineEncoding({
            name: "EUCJPtoSJIS", convert: function (c) {
                for (var k = p.SJIS, g = p.SJISInverted, h = g[12539], f = c.length, b = new Buffer(2 * f), a = 0, d = 0; d < f;) {
                    var e = c[d++]; if (128 > e) b[a++] = e; else if (142 === e) b[a++] = c[d++];
                    else if (143 === e) b[a++] = h >> 8, b[a++] = h & 255, d += 2; else { var l = c[d++]; e & 1 ? (e >>= 1, e = 111 > e ? e + 49 : e + 113, l = 223 < l ? l - 96 : l - 97) : (e >>= 1, e = 111 >= e ? e + 48 : e + 112, l -= 2); var m = ((e & 255) << 8) + l; 60736 <= m && 61180 >= m && (l = g[k[m]] || h, e = l >> 8, l &= 255); b[a++] = e; b[a++] = l }
                } return b.slice(0, a)
            }
        }); n.defineEncoding({
            name: "EUCJPtoJIS", convert: function (c) {
                for (var k = c.length, g = new Buffer(3 * k + 4), h = 0, f = 0, b = 0; b < k;) {
                    var a = c[b++]; 128 > a ? (0 !== f && (f = 0, g[h++] = 27, g[h++] = 40, g[h++] = 66), g[h++] = a) : (142 === a ? 1 !== f && (f = 1, g[h++] = 27, g[h++] = 40, g[h++] = 73) : 143 ===
                        a ? (3 !== f && (f = 3, g[h++] = 27, g[h++] = 36, g[h++] = 40, g[h++] = 68), g[h++] = c[b++] - 128) : (2 !== f && (f = 2, g[h++] = 27, g[h++] = 36, g[h++] = 66), g[h++] = a - 128), g[h++] = c[b++] - 128)
                } 0 !== f && (g[h++] = 27, g[h++] = 40, g[h++] = 66); return g.slice(0, h)
            }
        })
})();